...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortByPanel = __webpack_require__(186);

	var _SortByPanel2 = _interopRequireDefault(_SortByPanel);

	var _LikesPanel = __webpack_require__(187);

	var _LikesPanel2 = _interopRequireDefault(_LikesPanel);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function fetchProductList() {
	      var _this2 = this;

	      fetch('https://hackerearth.0x10.info/api/accolite_product?type=json&query=list_product').then(function (response) {
	    ...
	    value: function handleLikeToggle(name, count, type) {
	      switch (type) {
	        case 1:
	          count = count + 1;
	          var incrementLike = (0, _reactAddonsUpdate2.default)(this.state.likes, {
	            $merge: _defineProperty({}, name, [count])
	          });
	          this.setState({ likes: incrementLike });
	          break;
	        case 0:
	          count = count - 1;
	          var decrementLike = (0, _reactAddonsUpdate2.default)(this.state.likes, {
	            $merge: _defineProperty({}, name, [count])
	          });
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                'AccoHub — a simplified way to search accolite products!'
	              )
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'col-sm-3' },
	              _react2.default.createElement(_SortByPanel2.default, { handleSortFilterCallback: this.handleSortFilter.bind(this) }),
	              _react2.default.createElement(_LikesPanel2.default, { likes: this.state.likes })
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: 'col-sm-9' },
	              _react2.default.createElement(_Search2.default, { menu: this.state.menu,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortByPanel = function (_Component) {
	  _inherits(SortByPanel, _Component);

	  function SortByPanel() {
	    _classCallCheck(this, SortByPanel);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SortByPanel).apply(this, arguments));
	  }

	  _createClass(SortByPanel, [{
	    key: "handleSortFilter",
	    value: function handleSortFilter(e) {
	      e.preventDefault();
	      var sortElement = this.refs.sortByForm.searchSort.value;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "form",
	          { name: "sortByForm", ref: "sortByForm", onSubmit: this.handleSortFilter.bind(this) },
	          _react2.default.createElement(
	            "li",
	            null,
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "span",
	              null,
	              _react2.default.createElement("input", { type: "radio", name: "searchSort", value: "rating" }),
	              " "
	            ),
	            "Ratings"
	          ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LikesPanel = function (_Component) {
	  _inherits(LikesPanel, _Component);

	  function LikesPanel() {
	    _classCallCheck(this, LikesPanel);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(LikesPanel).apply(this, arguments));
	  }

	  _createClass(LikesPanel, [{
	    key: 'render',
	    value: function render() {
	      var likes = this.props.likes;

	      var sum = 0;
	      var likeVals = Object.keys(likes).map(function (key) {
	        return likes[key];
	      });
	      for (var i = 0; i < likeVals.length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function (_Component) {
	  ...
	  _createClass(Search, [{
	    ...
	    key: 'sortByType',
	    value: function sortByType(data, sortType) {
	      switch (sortType) {
	        case 'rating':
	    ...
	    value: function render() {
	      ...
	      var countResult = this.props.menu.length;
	      var renderContent = void 0,
	          filteredResults = void 0,
	          tagsList = void 0,
	          tagsSuggestions = void 0;

	      //check if searchText is empty
	      filteredResults = this.props.menu.filter(function (item) {
	        return item.tags.indexOf(_this2.props.searchText) !== -1;
	      });
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'search' },
	        _react2.default.createElement('input', { type: 'text', placeholder: 'Search here...', onChange: this.handleInputChange.bind(this) }),
	        renderContent
	      );
	    }
	  }]);
	...
	Search.propTypes = {
	  ...
	  handleLikeToggleCallback: _react.PropTypes.func.isRequired,
	  searchInputCallback: _react.PropTypes.func.isRequired,
	  searchText: _react.PropTypes.string,
	  isFetched: _react.PropTypes.bool
	};

	var ResultList = function (_Component2) {
	  _inherits(ResultList, _Component2);
	  ...
	  _createClass(ResultList, [{
	    ...
	    value: function render() {
	      ...
	      var resultList = menu.map(function (item) {
	        return _react2.default.createElement(_Item2.default, { key: item.name,
	          name: item.name,
	          rating: item.rating,
	          image: item.image,
	          tags: item.tags,
	          ...
	          link: item.link,
	          handleLikeToggleCallback: _this4.props.handleLikeToggleCallback.bind(_this4),
	          likes: _this4.props.likes[item.name] || 0 });
	      });
	      return _react2.default.createElement(
	        'div',
	...
	var Loading = function (_Component3) {
	  _inherits(Loading, _Component3);
	  ...
	  _createClass(Loading, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'loading' },
	        _react2.default.createElement('img', { src: '../images/ball.gif' }),
	        _react2.default.createElement(
	          'h4',
	          null,
	          'Loading...'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function (_Component) {
	  ...
	  _createClass(Item, [{
	    key: "handleLikeToggle",
	    value: function handleLikeToggle(e) {
	      e.preventDefault();
	      var form = void 0,
	          name = void 0,
	          count = void 0,
	    ...
	    value: function render() {
	      ...
	      var type = 1;
	      var printTags = tags.map(function (tag) {
	        return _react2.default.createElement(Tag, { key: tag, tag: tag });
	      });

	      return _react2.default.createElement(
	        "div",
	        { className: "result_item container-fluid" },
	        _react2.default.createElement(
	          "div",
	          { className: "row" },
	          _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "form",
	              { ref: "toggleLikeForm", id: "toggleLikeForm", onSubmit: this.handleLikeToggle.bind(this) },
	              _react2.default.createElement(
	                "strong",
	                null,
	                likes
	              ...
	              " ",
	              _react2.default.createElement("input", { type: "hidden", name: "name", value: name }),
	              _react2.default.createElement("input", { type: "hidden", name: "count", value: likes }),
	              _react2.default.createElement("input", { type: "hidden", name: "type", value: type }),
	              _react2.default.createElement(
	                "button",
	                { type: "submit" },
	                type ? "Like" : "Unlike"
